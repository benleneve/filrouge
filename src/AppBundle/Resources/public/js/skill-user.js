$(document).ready(function() {
    ...
    var $containerSkill = $('div#appbundle_user_UserSkills');

    // On ajoute un lien pour ajouter une nouvelle compétence
    var $addLinkSkill = $('<a href="#add_userSkills" id="add_userSkills" class="btnAction newSkill">> Ajouter une compétence</a>');
